        ...
        <Row>
          <Col md={4}>
            <div className={Styles.author}>
              <img src={Profile} alt="Profile" className={Styles.author_profile} />
              <h1>Awais Khalid</h1>
              <div className={Styles.about_author}>
                ...
                <p>
                  <FaFacebook size={30} style={{ marginRight: '1rem', color: '#3b5998' }} />
                  <FaSquareXTwitter size={30} style={{ marginRight: '1rem', color: '#1DA1F2' }} />
          ...
          <Col md={8}>
            {Blogs.map((blog) => {
              return (
                <Col key={blog.id} md={12} className={Styles.blog_card}>
